...
def donate_embed(avatar_url):
    ...
    embed.description = 'Hey! Thank you for choosing <@968509913531809862> bot!\nHere is the `donate information` in case you want to support and make the bot **thrive** even more in the future! All means of support are **appreciated** :kissing_heart:'
